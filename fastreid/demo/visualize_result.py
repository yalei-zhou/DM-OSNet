...
if __name__ == '__main__':
    ...
    # args = Namespace(config_file='/home/zyl/fast-reid/configs/osnet/sbs_R50-ibn.yml', dataset_name='Market1501', label_sort='ascending', max_rank=10, num_vis=3368, opts=['MODEL.WEIGHTS', '/home/zyl/fast-reid/weights/fastreidoriginalosnet_Map83.pth'], output='/home/zyl/fast-reid/visual/osnet_sbs_3368', parallel=False, rank_sort='descending', vis_label=True)
    args = Namespace(config_file='/home/zyl/fast-reid/configs/osnet/sbs_R50-ibn.yml', dataset_name='Market1501', label_sort='ascending', max_rank=10, num_vis=3368, opts=['MODEL.WEIGHTS', '/home/zyl/fast-reid/weights/model_best_zl_osnet100.pth'], output='/home/zyl/fast-reid/visual/osnet100zl_sbs_3368', parallel=False, rank_sort='descending', vis_label=True)
